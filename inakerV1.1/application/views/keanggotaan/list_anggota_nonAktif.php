        ...
        <section class="col-lg-12 connectedSortable">
                ...
                <form action="" method="">
                      ...
                      <div class="row control-group">
                            <table id="peminjaman" class="table table-bordered table-hover table-striped tablesorter">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class='text-center'>
                                    <div class='btn-group'>
                                      <a href="<?php echo base_url(); ?>c_keanggotaan/detail_anggota_nonAktif/<?php echo $row->id_anggota; ?>" class='btn btn-info'>
