    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
				...
				?>
       <form method="post" action="<?=base_url();?>c_anggota/ProsesupdatePassword/<?=$Array['id_anggota']?>" enctype="multipart/form-data">
<table border="0" align="center" class="table responsive">
    ...
    <td colspan="2"><input name="Nama" type="text" class="form-control" value="<?=$Array['nama_ang']?>"  required autofocus/></td>
    </tr>
    <tr>
      <th scope="row"><label for="dtp_input2" class="col-sm-14 control-label">Tempat  Tanggal Lahir</label>
      <td width="201"><input name="tempat" type="text" class="form-control" value="<?=$Array['tempat_lahir_ang']?>" required autofocus/></td>
    <td width="144">
    <input class="form-control" size="10" type="date" name="tgl" class="form-control" value="<?=$Array['tgl_lahir_ang']?>"></td> 
   </tr>
  ...
  <tr>
    ...
    <td colspan="2"><input name="alamat" type="text" maxlength="75" class="form-control" value="<?=$Array['alamat_ang']?>" required autofocus/></td>
    </tr>
     <tr>
       <th scope="row">No Hp </th>
    <td colspan="2"><input name="NoHp" type="text" maxlength="12" class="form-control" value="<?=$Array['telp_ang']?>" required autofocus/></td>
    </tr>
    <tr>
      <th scope="row">Pekerjaan</th>
    <td colspan="2"><input name="pekerjaan" type="text" maxlength="35" class="form-control" value="<?=$Array['pekerjaan_ang']?>" required autofocus/></td>
    </tr>
    <tr>
      <th scope="row">Alamat Kantor / Kerja</th>
    <td colspan="2"><input name="alamatKerja" type="text" maxlength="12" class="form-control" value="<?=$Array['alamatkerja_ang']?>" required autofocus/></td>
    </tr> 
    <tr>
      <th scope="row">Username</th>
    <td colspan="2"><input name="username" type="username" class="form-control" value="<?=$Array['user_ang']?>" required autofocus/></td>
    </tr>
    <tr>
      <th scope="row">Alamat Email</th>
    <td colspan="2"><input name="AlamatEmail" type="email" class="form-control" value="<?=$Array['email_ang']?>" required autofocus/></td>
    </tr>
   <tr>
 ...
 <input name="ktp" type="hidden" class="form-control" value="<?=$Array['ktp_ang']?>" placeholder="" readonly/>
      ...
      <th scope="row"><div align="right"><input type="submit" value="Change" class="btn btn-lg btn-success">
      </div></th>
    </tr>
