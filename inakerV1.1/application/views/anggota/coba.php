    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
				...
				?>
         <form method="post" action="<?=base_url();?>c_anggota/updatePassword" enctype="multipart/form-data">
<table border="0" align="center" class="table responsive">
  ...
  <tr>
    ...
    <tr>
      <th width="153" scope="row"><button type="button" class="btn btn-lg btn-success"  onClick="window.location.href='<?=base_url();?>c_anggota/updatePhoto/<?=$Array['id_anggota']?>'">Change Photo</button></th>
